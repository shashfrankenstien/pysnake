...
class _emoji(object):
	...
	def get_deadly(self):
		return list(self.Deadly.values())

	def get_random_food(self):
		return random.choice(self.get_foods())

	def get_random_face(self):
		return random.choice(self.get_faces())

	def get_random_death(self):
		return random.choice(self.get_deadly())
